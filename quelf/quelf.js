 $(document).ready(function() {
	...
	$("#roll").click(function(){
		...
		for (var i = 0; i < blueSpaces.length; i++) {
			console.log(blueSpaces[i]);
			if (p1s == blueSpaces[i]) {
				console.log(blueCards[Math.floor(Math.random() * blueCards.length)]);
				alert(blueCards[Math.floor(Math.random() * blueCards.length)]);
				break;
			}
		}
		for (var i = 0; i < greenSpaces.length; i++) {
			console.log(greenSpaces[i]);
			if (p1s == greenSpaces[i]) {
				console.log(greenCards[Math.floor(Math.random() * greenCards.length)]);
				alert(greenCards[Math.floor(Math.random() * greenCards.length)]);
				break;
			}
		}
		for (var i = 0; i < purpleSpaces.length; i++) {
			console.log(purpleSpaces[i]);
			if (p1s == purpleSpaces[i]) {
				console.log(purpleCards[Math.floor(Math.random() * purpleCards.length)]);
				alert(purpleCards[Math.floor(Math.random() * purpleCards.length)]);
				break;
			}
		}
		for (var i = 0; i < redSpaces.length; i++) {
			console.log(redSpaces[i]);
			if (p1s == redSpaces[i]) {
				console.log(redCards[Math.floor(Math.random() * redCards.length)]);
				alert(redCards[Math.floor(Math.random() * redCards.length)]);
				break;
			}
		}
		for (var i = 0; i < yellowSpaces.length; i++) {
			console.log(yellowSpaces[i]);
			if (p1s == yellowSpaces[i]) {
				console.log(yellowCards[Math.floor(Math.random() * yellowCards.length)]);
	...
	$("#roll1").click(function(){
		...
		loadScore();
		for (var i = 0; i < blueSpaces.length; i++) {
			console.log(blueSpaces[i]); // Logging how many blue spaces you have
			if (p1s == blueSpaces[i]) {
				console.log(blueCards[Math.floor(Math.random() * blueCards.length)]);
				alert(blueCards[Math.floor(Math.random() * blueCards.length)]);
				break;
